...
#else
static char name_comp1[]   = "Camera 1";
static char name_comp2[]   = "Camera 2";
static char name_comp3[]   = "Camera 3";
static char name_comp4[]   = "Camera 4";
#endif
 ...
 */
DEFINE_PCI_DEVICE_TABLE(tw68_pci_tbl) = {
	{
